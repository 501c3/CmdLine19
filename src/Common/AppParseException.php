...
class AppParseException extends \Exception
{
    ...
    private function message($code,$pathfile=null,$found=null,$position=null,$expected=null)
    {
        ...
        switch($code) {
            ...
            case AppExceptionCodes::MISSING_FILE:
                return self::messageTF($code,$file);
            default:
     ...
     * @return string
     */
    public static function messageTF($code,$file)
    {
        return sprintf(self::MESSAGE_TF, $file, $code);
    }
